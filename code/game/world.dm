...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"https://www.guilded.gg/i/WknWP44p\">" //Change this to wherever you want the hub to link to.
	s += "Guilded"  //Replace this with something else. Or ever better, delete it and uncomment the game version.
	s += "</a>"
	s += "|"
