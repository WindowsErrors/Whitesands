...
/obj/item/storage/box/syndicate/bundle_A/PopulateContents()
	switch (pickweight(list("recon" = 1, "bloodyspai" = 1, "stealth" = 1, "screwed" = 1, "sabotage" = 1, "guns" = 1, "murder" = 1, "implant" = 1, "hacker" = 1, "sniper" = 1, "metaops" = 1)))
		if("recon")
...
/obj/item/storage/box/syndicate/bundle_B/PopulateContents()
	switch (pickweight(list( "bond" = 1, "ninja" = 1, "darklord" = 1, "white_whale_holy_grail" = 1, "mad_scientist" = 1, "bee" = 1, "mr_freeze" = 1, "made_man"= 1)))
		if("bond")
